    ...
    <x-card>
        <form method="post" action="{{ route('project.update', $project->id) }}" x-data="{ formAction: '{{ route('project.update', $project->id) }}' }"
            ...
            <div class="space-y-4 md:space-y-8">
                ...
                <div>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 md:gap-4 space-y-4">
            ...
            <div class="flex justify-end gap-2 mt-8">
                ...
                <x-primary-button class="w-1/2 md:w-1/6" type="button"
                    @click.prevent="formAction = '{{ route('project.update', $project->id) }}'; $nextTick(() => $el.closest('form').submit())">
                    {{ __('آپدیت') }}
                </x-primary-button>
            </div>
        </form>
