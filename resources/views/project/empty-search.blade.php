<div class="flex items-center m-auto mt-20 md:mt-32 text-center rounded-lg">
    <div class="w-full">
        <div class="relative mb-32">
            <svg class="w-[300px] h-[200px] md:w-[450px] md:h-[300px] absolute top-0 left-0 bottom-0 right-0 m-auto fill-gray-300 dark:fill-gray-800 opacity-20"
            ...
            <div id="animation-area" class="flex absolute top-0 left-0 bottom-0 right-0 m-auto text-lg size-10">
                <span id="animation-area-emoji" class="inline-block text-3xl md:text-4xl">
                    🔍
                </span>
            </div>
        </div>
        ...
        <div>
            <p class="text-text text-sm font-bold mb-2">{{ __('نتیجه‌ای یافت نشد') }}</p>
            <p class="text-text-600 dark:text-gray-400 text-sm justify-center">
                {{ __('از کلمه‌ای دیگر برای جستجوی استفاده کنید') }}
            </p>
        </div>
    </div>
</div>
