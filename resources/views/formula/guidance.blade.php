<div>
    ...
    <ul class="mt-4 p-4 text-text text-xs space-y-1 list-disc leading-6 lg:leading-5">
        ...
        <li>{{ __('برای اضافه کردن هریک از متغیرها، برچسب‌ها و یا عملگرها کافیست روی آن ضربه بزنید.') }}</li>
        <li>
        ...
        <li>
            {{ __('می‌توانید فرمول خود را در چند خط جدا بنویسید. انتهای هر خط با یک ') }}
            <span
                class="bg-background-100 border border-primary rounded-md text-text px-3 py-1">{{ '=' }}</span>
            {{ __(' و به دنبال آن یک ') }}
            <span class="text-white bg-accent px-1.5 py-1 rounded-md">{{ __('برچسب') }}</span>
        ...
        <li>
            {{ __('به صورت خودکار هر عبارت ریاضی پس از علامت ') }}
            <span
                class="bg-background-100 border border-primary rounded-md text-text px-3 py-1">{{ '=' }}</span>
            {{ __('و ') }}
            <span class="text-white bg-accent px-1.5 py-1 rounded-md">{{ __('برچسب') }}</span>
