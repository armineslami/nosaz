                        ...
                        @foreach($labels as $label)
                            @if($label->is_parent)
                                <div class="flex flex-row gap-2 bg-gray-300 dark:bg-gray-800 rounded-md p-1">
                                    <div data-is-parent="true" data-id="{{ $label->id }}" class="flex justify-between items-center bg-accent-500 dark:bg-accent py-1.5 px-2.5 min-w-16 rounded-md text-text text-sm cursor-default">
                                    ...
                                    @foreach($label->children as $_label)
                                        <div data-parent-id="{{ $label->id }}" class="flex justify-between items-center bg-accent-400 dark:bg-accent-600 py-1.5 px-2.5 min-w-16 rounded-md text-text text-sm cursor-default">
