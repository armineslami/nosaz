<div
    class="block md:hidden fixed bottom-0 left-0 z-10 w-full h-20 bg-background border-t border-gray-200 dark:border-gray-600">
            ...
            <ul class="mb-2">
                <li>
                    <a href="{{ route('project.create') }}"
                        class="flex text-sm w-ful px-4 py-2 {{ Route::is('project.create') || Route::is('project.calculate') ? 'bg-primary text-text-900 dark:text-text-100 border-b border-b-primary-400' : 'text-text hover:text-text-900 hover:dark:text-text-100' }} transition duration-75 pl-11 group hover:bg-primary">
                        {{ __('محاسبه') }}
                    </a>
                </li>
                <li>
