           ...
           <div class="overflow-y-scroll">
               ...
               <div>
                   <div
                       ...
                       <span class="ms-4 text-sm">{{ __('پروژه‌ها') }}</span>
                       <svg class="w-2 h-2 absolute end-4 bottom-0 top-0 m-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                   ...
                   <ul id="project-dropdown" class="{{ Route::is('project.*') ? '' : 'hidden' }} py-2 space-y-1 mt-1">
                       <li>
                           <a href="{{ route('project.create') }}" class="flex text-xs w-full ms-4 px-4 py-2 text-gray-500 dark:text-gray-400 transition duration-75 rounded-md pl-11 group hover:bg-gray-100 dark:hover:bg-gray-700">
                               {{ __('ساخت پروژه') }}
                           </a>
                       </li>
                       <li>
                           <a href="{{ route('project.index') }}" class="flex text-xs w-full ms-4 px-4 py-2 text-gray-500 dark:text-gray-400 transition duration-75 rounded-md pl-11 group hover:bg-gray-100 dark:hover:bg-gray-700">
                               {{ __('پروژه‌ها') }}
                           </a>
                       </li>
                   </ul>
               ...
               <div>
                   <div
                           aria-controls="formula-dropdown" data-collapse-toggle="formula-dropdown"
                       ...
                       <span class="bg-accent rounded border-0 text-xsmall px-1 py-0.5 ms-2 text-white font-bold">{{ __('آزمایشی') }}</span>
                   ...
                   <ul id="formula-dropdown" class="{{ Route::is('formula.*') ? '' : 'hidden' }} py-2 space-y-1 mt-1">
                       <li>
                           <a href="{{ route('formula.create') }}" class="flex text-xs w-full ms-4 px-4 py-2 text-gray-500 dark:text-gray-400 transition duration-75 rounded-md pl-11 group hover:bg-gray-100 dark:hover:bg-gray-700">
                               {{ __('ساخت فرمول') }}
                           </a>
                       </li>
                       <li>
                           <a href="{{ route('formula.index') }}" class="flex text-xs w-full ms-4 px-4 py-2 text-gray-500 dark:text-gray-400 transition duration-75 rounded-md pl-11 group hover:bg-gray-100 dark:hover:bg-gray-700">
                               {{ __('فرمول‌ها') }}
                           </a>
                       </li>
                       <li>
                           <a href="{{ route('formula.variable.create') }}" class="flex text-xs w-full ms-4 px-4 py-2 text-gray-500 dark:text-gray-400 transition duration-75 rounded-md pl-11 group hover:bg-gray-100 dark:hover:bg-gray-700">
                               {{ __('متغیرها') }}
                           </a>
                       </li>
                   </ul>
