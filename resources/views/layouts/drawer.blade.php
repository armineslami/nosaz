            ...
            <div>
                ...
                <div>
                    <div aria-controls="project-dropdown" data-collapse-toggle="project-dropdown"
                        class="flex relative cursor-pointer items-center px-4 py-2 mt-2 rounded-md {{ Route::is('project.*') ? 'primary-button bg-primary text-text-900 dark:text-text-100' : 'primary-button text-gray-900 dark:text-gray-100 hover:bg-primary dark:hover:text-text-100 dark:hover:bg-primary' }}">
                        <svg class="size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <ul id="project-dropdown" class="{{ Route::is('project.*') ? '' : 'hidden' }} py-2 space-y-1 mt-1">
                        ...
                        <li>
                            <a href="{{ route('project.index') }}"
                                class="flex text-xs w-full ms-4 px-4 py-2 {{ Route::is('project.index') ? 'text-text bg-primary-200 dark:bg-primary-100' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }} transition duration-75 rounded-md pl-11 group">
                                {{ __('پروژه‌ها') }}
                            </a>
                        </li>
                    </ul>
                ...
                <div>
                    <div aria-controls="formula-dropdown" data-collapse-toggle="formula-dropdown"
                        class="flex cursor-pointer items-center px-4 py-2 mt-2 rounded-md {{ Route::is('formula.*') ? 'primary-button bg-primary text-text-900 dark:text-text-100' : 'primary-button text-gray-900 dark:text-gray-100 hover:bg-primary dark:hover:text-text-100 dark:hover:bg-primary' }}">
                        <svg class="size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
