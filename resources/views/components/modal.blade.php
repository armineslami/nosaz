...
<div x-data="{
    ...
    x-on:close.stop="show = false; $dispatch('modal-closed', '{{ $name }}');"
    x-on:keydown.escape.window="show = false; $dispatch('modal-closed', '{{ $name }}');"
    ...
    <div x-show="show" class="fixed inset-0 transform transition-all"
        x-on:click="show = false; $dispatch('modal-closed', '{{ $name }}');"
