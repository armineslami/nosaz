...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/oauth/telegram/redirect', [OAuthController::class, 'redirectToTelegram'])
        ->name('telegram.redirect');
    Route::get('/oauth/telegram/callback', [OAuthController::class, 'callbackFromTelegram'])
